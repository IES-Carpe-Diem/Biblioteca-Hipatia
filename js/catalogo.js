...
async function cargarPortadasDesdeGitHub() {
    try {
        ...
        console.log(`Detectadas ${portadasFiles.length} portadas en total (debería ser ~1355)`);
        ...
        // showToast('Problema al cargar todas las portadas. Algunas podrían no verse.', 'warning');  // Comentado para evitar mensaje innecesario
    }
}
