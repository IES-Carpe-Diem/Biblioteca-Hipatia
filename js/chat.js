// js/chat.js
// Módulo responsable del chat con Hipat-IA (bibliotecaria virtual usando Gemini)
// Incluye:
//   - Envío de mensajes y manejo de respuestas
//   - Detección de intenciones (sinopsis, ejemplares, recomendaciones, etc.)
//   - Generación de sinopsis y respuestas con Gemini API
//   - Historial de conversación, caché de respuestas y división de mensajes largos
//   - Integración con catálogo para respuestas contextuales
